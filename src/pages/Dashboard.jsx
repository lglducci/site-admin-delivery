...
const COLUNAS = [
  { status: "recebido",  titulo: "Recebido",  cls: "bg-[#211b15] text-[#ffcf88]" },
  { status: "producao",  titulo: "Produção",  cls: "bg-[#211b15] text-[#ffcf88]" },
  { status: "entrega",   titulo: "Entrega",   cls: "bg-[#211b15] text-[#ffcf88]" },
  { status: "concluido", titulo: "Concluído", cls: "bg-[#211b15] text-[#ffcf88]" },
];
